...
function wdsAccordion() {
  const accordionItems = document.querySelectorAll('.wds-module-accordion .accordion-item'),
        accordionTriggers = document.querySelectorAll('.wds-module-accordion .accordion-title'),
